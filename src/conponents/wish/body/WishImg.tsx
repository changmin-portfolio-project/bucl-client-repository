...
const WishImg: React.FC<ReviewImgItemProps> = ({
  style,
  dotBoolean,
  imgPath,
}) => {
  ...
  return (
    <WishImgItemContainer style={style} $widthMode={Array.isArray(imgPath)}>
    ...
    </WishImgItemContainer>
  );
};

const WishImgItemContainer = styled.div<{ $widthMode: boolean }>`
  position: relative;
  margin-right: 4px;
